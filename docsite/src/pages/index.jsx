            ...
            <div className='overflow-hidden'>
                ...
                {/* <section id="pricing" className="py-20 bg-slate-50 dark:bg-slate-900/50">
                    <div className="container px-4 md:px-6">
                        <div className="flex flex-col items-center justify-center space-y-4 text-center">
                            <div className="space-y-2">
                                <div className="inline-block rounded-lg bg-red-100 px-3 py-1 text-sm font-medium text-red-800 dark:bg-red-900/30 dark:text-red-500">
                                    Pricing
                                </div>
                                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">
                ...
                <section className="py-20">
                    <div className="container px-4 md:px-6">
                        <div className="grid gap-6 lg:grid-cols-[1fr_500px] lg:gap-12">
                            <div className="flex flex-col justify-center space-y-4">
                                <div className="space-y-2">
                                    <div className="inline-block rounded-lg bg-yellow-100 px-3 py-1 text-sm font-medium text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-500">
                            ...
                            <div className="flex items-center justify-center rounded-lg border bg-slate-50 p-8 dark:bg-slate-900/50">
                                <div className="space-y-4 text-center">
                                    ...
                                    <blockquote className="text-lg font-semibold">
                                        "TukTuk has revolutionized how we handle time-based operations on-chain. It's reliable, fast, and
                                        incredibly easy to use."
                                    </blockquote>
                                    <div className="text-sm text-muted-foreground">— Abhay Kumar, Builder of Chains at Helium</div>
                                </div>
                            </div>
                        </div>
                    </div>
