    ...
    >
      ...
      {hierarchy.length > 0 && (
        <div
          id={`${id}-hierarchy`}
          aria-hidden="true"
          className="mt-0.5 truncate whitespace-nowrap text-xs text-zinc-900 dark:text-zinc-400"
        >
              ...
              <span
                className={
                  itemIndex === items.length - 1
                    ? 'sr-only'
                    : 'mx-2 text-zinc-500 dark:text-zinc-700'
                }
              >
                /
              </span>
...
export function Search() {
  ...
  return (
    <>
      <button
        type="button"
        className="group flex h-6 w-6 items-center justify-center sm:justify-start md:h-8 md:w-80 md:rounded-full md:pl-4 md:pr-3.5 md:text-sm md:ring-1 md:bg-gray-300 md:ring-inset md:ring-white/5 md:hover:bg-zinc-500/40 lg:w-[284px]"
        {...buttonProps}
      >
