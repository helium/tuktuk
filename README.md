...
```bash
tuktuk -u <your-solana-url> task-queue create --name <your-queue-name> --capacity 10 --funding-amount 100000000 --queue-authority <the-authority-to-queue-tasks> --min-crank-reward 1000000 --stake-task-age 172800
```
